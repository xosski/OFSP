"""
Agent Integration Module for HadesAI
This module provides the Autonomous Coding Agent tab and methods.
Add these methods to the HadesGUI class.
"""

from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QTextEdit, QLabel,
    QPlainTextEdit, QGroupBox, QFormLayout, QSpinBox, QCheckBox, QMessageBox
)
...
# These imports must be added to HadesAI.py:
...
def agent_llm(self, system_prompt: str, user_prompt: str) -> str:
...
def on_agent_log(self, text: str):
...
def on_agent_diff(self, data: Dict):
...
def on_agent_finished(self, result: Dict):
